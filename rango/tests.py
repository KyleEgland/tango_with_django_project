#! python
#
# Test script taken from the "tango_with_django_19" GitHub repository:
# https://github.com/leifos/tango_with_django_19/blob/master/code/tango_with_
# django_project/rango/tests.py
...
class AboutPageTests(TestCase):
    ...
    def test_about_contains_create_message(self):
        ...
        # message. Exercise from Chapter 4
