...
import os
import tango_with_django_project.settings_secret as settings

# Build paths inside the project like this: os.path.join(BASE_DIR, ...)
# The inner most abspath will get to the folder containing this file while the
# next one out will get the abspath for the project
